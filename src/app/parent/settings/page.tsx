...
import { User, Mail, Phone, Book, Users, Calendar, KeyRound, Bell, Shield, Loader2, Eye, EyeOff, Laptop, Smartphone, MessageSquare, GraduationCap } from "lucide-react"
            ...
            <CardContent>
                 <Tabs defaultValue="profile">
                    <TabsList className="grid w-full grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
                        ...
                        <TabsTrigger value="reminders"><Bell className="mr-2"/>Reminders</TabsTrigger>
                                ...
                                <Card>
                                    <CardHeader className="items-center text-center">
                                        <Avatar className="w-24 h-24 mb-4">
                                            <AvatarImage src="https://picsum.photos/seed/parent/128/128" />
                                            <AvatarFallback>AP</AvatarFallback>
                                        </Avatar>
                                        <CardTitle>Mr. Patel</CardTitle>
                                        <CardDescription>Parent</CardDescription>
                                    </CardHeader>
                                    <CardContent className="text-sm text-muted-foreground space-y-4">
                                        <div className="flex items-center gap-3"><Mail /><span className="truncate">p.patel@email.com</span></div>
                                        <div className="flex items-center gap-3"><Phone /><span>+91 98765 12345</span></div>
                                        <Separator />
                                         <div className="flex items-center gap-3"><GraduationCap /><span className="font-semibold text-foreground">Linked Student: Aarav Patel</span></div>
                                         <p>Roll No: 201</p>
                                            ...
                                            render={({ field }) => (
                                                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                                                    <div className="space-y-0.5">
                                                        ...
                                                        <FormDescription>Get alerts for your child's absences.</FormDescription>
                                                    </div>
                                            ...
                                            render={({ field }) => (
                                                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                                                    <div className="space-y-0.5">
                                                        ...
                                                        <FormDescription>Get notified when a new task is assigned.</FormDescription>
                                                    </div>
                                                    <FormControl><Switch checked={field.value} onCheckedChange={field.onChange} /></FormControl>
                                                </FormItem>
                                            )}
