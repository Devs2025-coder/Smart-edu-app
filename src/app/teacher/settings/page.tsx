...
import { User, Mail, Phone, Book, Users, Calendar, KeyRound, Bell, Shield, Loader2, Eye, EyeOff, Laptop, Smartphone, MessageSquare } from "lucide-react"
...
const notificationsFormSchema = z.object({
    ...
    parentQueries: z.boolean().default(true),
    taskSubmissions: z.boolean().default(false),
                                ...
                                <Card>
                                    <CardHeader className="items-center text-center">
                                        <Avatar className="w-24 h-24 mb-4">
                                            <AvatarImage src="https://picsum.photos/seed/teacher/128/128" />
                                    ...
                                    <CardContent className="text-sm text-muted-foreground space-y-4">
                                        <div className="flex items-center gap-3"><Mail /><span className="truncate">priya.sharma@school.edu</span></div>
                                        <div className="flex items-center gap-3"><Phone /><span>+91 98765 43210</span></div>
                                        <div className="flex items-center gap-3"><Book /><span>Handles: Math, Science</span></div>
                                        <div className="flex items-center gap-3"><Users /><span>Classes: Grade 6A, 7B</span></div>
                                        <div className="flex items-center gap-3"><Calendar /><span>Joined: Aug 1, 2022</span></div>
                                    </CardContent>
                                </Card>
                            </div>
                                    ...
                                    <CardContent className="space-y-6">
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                                                    <div className="space-y-0.5">
                                                        <FormLabel className="text-base">Parent Communication</FormLabel>
                                                        <FormDescription>Get notified when parents send you a message.</FormDescription>
                                                    </div>
                                                    <FormControl><Switch checked={field.value} onCheckedChange={field.onChange} /></FormControl>
                                                </FormItem>
                                            )}
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                                                    <div className="space-y-0.5">
                                                        <FormLabel className="text-base">Task Submissions</FormLabel>
                                                        <FormDescription>Get notified when students submit their work.</FormDescription>
                                                    </div>
                                                    <FormControl><Switch checked={field.value} onCheckedChange={field.onChange} /></FormControl>
                                                </FormItem>
                                            )}
