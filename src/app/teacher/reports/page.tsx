...
const attendanceData = [
  { student: { id: 'S001', name: 'Aarav Sharma' }, total: 40, attended: 38 },
  { student: { id: 'S002', name: 'Saanvi Gupta' }, total: 40, attended: 35 },
  { student: { id: 'S003', name: 'Vihaan Singh' }, total: 40, attended: 25 },
  { student: { id: 'S004', name: 'Myra Reddy' }, total: 40, attended: 39 },
  { student: { id: 'S005', name: 'Advik Patel' }, total: 40, attended: 30 },
  { student: { id: 'S006', name: 'Anika Desai' }, total: 40, attended: 36 },
];

const taskData = [
  { student: { id: 'S001', name: 'Aarav Sharma' }, assigned: 5, completed: 5 },
  { student: { id: 'S002', name: 'Saanvi Gupta' }, assigned: 5, completed: 4 },
  { student: { id: 'S003', name: 'Vihaan Singh' }, assigned: 5, completed: 2 },
  { student: { id: 'S004', name: 'Myra Reddy' }, assigned: 5, completed: 5 },
  { student: { id: 'S005', name: 'Advik Patel' }, assigned: 5, completed: 3 },
  { student: { id: 'S006', name: 'Anika Desai' }, assigned: 5, completed: 4 },
];
            ...
            <Card>
                <CardHeader>
                    <div>
                        ...
                        <CardDescription>
                            Analyze class performance for Grade 6 - Section A.
                        </CardDescription>
                    </div>
                </CardHeader>
                <CardContent>
